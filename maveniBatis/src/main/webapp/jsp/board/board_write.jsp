...
<head>
	<meta charset="UTF-8">
	<title>게시판 입력폼</title>
	<link rel="stylesheet" type="text/css" href="/maveniBatis/css/bbs.css" />
	<script src="http://code.jquery.com/jquery-latest.js"></script>
	<script src="/maveniBatis/js/board.js"></script>
</head>

<body>
 <div id="bbswrite_wrap">
  <h2 class="bbswrite_title">게시판 입력폼</h2>
  <form method="post" action="/maveniBatis/board_write_ok.nhn">
   <table id="bbswrite_t">
    <tr>
     <th>글쓴이</th>
     <td>
