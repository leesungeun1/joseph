...
function selectnow() {
	...
	*/
	...
	opener.document.f.join_zip1.value=zip1;
    //opener객체는 우편번호 공지창에서 본 회원가입창을 가리킨다. 
	/* 회원가입창에 첫번째 세자리 우편번호를 입력한다. */

	opener.document.f.join_zip2.value=zip2;

	/* 회원가입창에 두번째 세자리 우편번호를 입력한다. */

	opener.document.f.join_addr1.value=addr2;
...
<form method="post" action="zicode_find_ok.nhn" name="postform" onsubmit="return check(this)">
