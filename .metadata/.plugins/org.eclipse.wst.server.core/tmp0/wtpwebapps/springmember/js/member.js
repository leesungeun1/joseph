...
/* 아이디 중복 체크{실무에서 많이 사용한다.}*/
function id_check(){
	$("#idcheck").hide();//idcheck span 아이디 영역을 숨긴다.
	var memid=$("#join_id").val();//val함수로 사용자 값을 불러온다.
	//1.입력글자 길이 체크
	...
	var mpass = "123456";
	//현재 시장에서 많이 사용 아이디 중복확인{아작스 함수}
    $.ajax({
        type:"POST",
        /*url:"./jsp/member/member_idcheck.jsp",*/
        url:"/springmember/member_idcheck.nhn",
        data: {"memid":memid,"mpass":mpass},//data :{키, 벨류값}으로 작성  
        /*datatype:"POST",*/
