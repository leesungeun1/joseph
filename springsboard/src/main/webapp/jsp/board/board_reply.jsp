	...
	<div id="boardreply_wrap">
		...
		<form method="post" action="board_reply_ok.nhn">
			...
			<input type="hidden" name="board_re_ref"
				value="${bcont.board_re_ref}" /> <input type="hidden"
				name="board_re_lev" value="${bcont.board_re_lev}" /> <input
				type="hidden" name="board_re_seq" value="${bcont.board_re_seq}" />
			...
			<table id="boardreply_t">
				...
				<tr>
					...
					<td><input name="board_subject" id="board_subject" size="40"
						class="input_box" value="Re:${bcont.board_subject}" /></td>
				</tr>
			...
			<div id="boardreply_menu">
				<input type="submit" value="답변" class="input_button" /> <input
