...
<link rel="stylesheet" type="text/css"
	href="/springmember/css/admin.css" />
<link rel="stylesheet" type="text/css"
		...
		<form method="post" action="member_login_ok.nhn"
			...
			<div id="login_menu">
				<input type="submit" value="로그인" class="input_button" /> <input
					...
					onclick="$('#id').focus();" /> <input type="button" value="회원가입"
					class="input_button" onclick="location='member_join.nhn'" /> <input
					type="button" value="비번찾기" class="input_button"
					onclick="pwd_find()" />
			</div>
		</form>
	</div>
