...
<link rel="stylesheet" type="text/css"
	href="/springmember/css/member.css" />
<!-- <script src="/springmember/js/jquery.js"></script> -->
<script src="http://code.jquery.com/jquery-latest.js"></script>
<script src="/springmember/js/member.js"></script>
			...
			<table id="join_t">
				<tr>
					...
					<td><input name="join_id" id="join_id" size="14"
						...
						<div id="idcheck"></div></td><!--보통 기업들에서 많이 쓰임.  -->
				</tr>
				...
				<tr>
					<th>우편번호</th>
					<td><input name="join_zip1" id="join_zip1" size="3"
						class="input_box" />-<input name="join_zip2" id="join_zip2"
						size="3" class="input_box" /> <input type="button"
						value="우편번호검색1" class="input_button" /> <input type="button"
						value="우편번호검색2" class="input_button" onClick="openDaumPostcode()" /></td>
				</tr>
