...
//		return gm;
	...
	public ModelAndView g_cont(@RequestParam("g_no") int g_no,
	...
	public String g_del_ok(@RequestParam("g_no") int g_no,
	...
	public String com_ok(@ModelAttribute ComBean c, HttpServletResponse response)
			throws Exception {
		response.setContentType("text/html;charset=UTF-8");
		PrintWriter out = response.getWriter();
	...
	public String com_del_ok(@RequestParam("comment_no") int comment_no,
			@RequestParam("g_no") int g_no, @RequestParam("state") String state) {
	...
	@ResponseBody
	public GBean cont(@RequestParam("g_no") int g_no){
